...
(function( root, factory ) {
    ...
    return (function( module_factory ) {
        ...
        if( typeof process === "object" && typeof process.versions === "object" && typeof process.versions.node === "string" ) {
            ...
            var wasm_path = path.join( __dirname, "symart_wasm.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            var file = fetch( "symart_wasm.wasm", {credentials: "same-origin"} );
            ...
            return wasm_instance
                .then( function( wasm_instance ) {
                    ...
                    console.log( "Finished loading Rust wasm module 'symart_wasm'" );
                    return exports;
                })
                .catch( function( error ) {
                    console.log( "Error loading Rust wasm module 'symart_wasm':", error );
                    throw error;
                });
        }
    }( function() {
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            ...
            "__cargo_web_snippet_12b634fbac3bc3d381d4f7b1fd5094b993fe1199": function($0, $1, $2, $3) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);$3 = Module.STDWEB_PRIVATE.to_js($3);Module.STDWEB_PRIVATE.from_js($0, (function(){try{return{value:function(){return($1).createImageData(($2),($3));}(),success:true};}catch(error){return{error:error,success:false};}})());
            },
            "__cargo_web_snippet_152c83cad440951498855478f2bcc8c7df3742af": function($0, $1) {
                $0 = Module.STDWEB_PRIVATE.to_js($0);$1 = Module.STDWEB_PRIVATE.to_js($1);($0).data.set(($1));
            },
            ...
            "__cargo_web_snippet_407e59d17f367da0e0c35dadee76c0df936d0c47": function($0, $1, $2, $3, $4) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);$3 = Module.STDWEB_PRIVATE.to_js($3);$4 = Module.STDWEB_PRIVATE.to_js($4);Module.STDWEB_PRIVATE.from_js($0, (function(){try{($1).putImageData(($2),($3),($4));return{success:true};}catch(error){return{error:error,success:false};}})());
            },
            ...
            "__cargo_web_snippet_6342b9727cf53d0c864ca62b4b096ada83c0acd8": function($0, $1, $2) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);Module.STDWEB_PRIVATE.from_js($0, (function(){return new JSONEditor(($1),{"schema":JSON.parse(($2)),"disable_edit_json":true,"disable_properties":true});})());
            },
            ...
            "__cargo_web_snippet_8eba8290b755ff698c63c02db5d934dcac489235": function($0) {
                Module.STDWEB_PRIVATE.from_js($0, (function(){return document.readyState=="complete"})());
            },
            ...
            "__cargo_web_snippet_977848a2237d0574625f3446de124411e41800c3": function($0) {
                var o = Module.STDWEB_PRIVATE.acquire_js_reference( $0 );return (o instanceof ImageData) | 0;
            },
            ...
            "__cargo_web_snippet_bf417ae01e51991f63c404c3d0ad996098f5dc8d": function($0) {
                var o = Module.STDWEB_PRIVATE.acquire_js_reference( $0 );return (o instanceof UIEvent && o.type === "load") | 0;
            },
            "__cargo_web_snippet_c1d56d77abf1a7eead2b7773afd66f83e0ad2970": function() {
                $("#form").tabs();
            },
            ...
            "__cargo_web_snippet_eb120a2d9f20cd21332fcd14775b7e6abc63c522": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){return JSON.stringify(($1).getValue());})());
            },
